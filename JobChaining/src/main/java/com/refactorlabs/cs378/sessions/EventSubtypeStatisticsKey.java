...
public class EventSubtypeStatisticsKey extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"EventSubtypeStatisticsKey\",\"namespace\":\"com.refactorlabs.cs378.sessions\",\"fields\":[{\"name\":\"session_type\",\"type\":\"string\",\"default\":\"any\"},{\"name\":\"event_subtype\",\"type\":\"string\",\"default\":\"any\"}]}");
  ...
  public static com.refactorlabs.cs378.sessions.EventSubtypeStatisticsKey.Builder newBuilder() {
    return new com.refactorlabs.cs378.sessions.EventSubtypeStatisticsKey.Builder();
  }
  
  /** Creates a new EventSubtypeStatisticsKey RecordBuilder by copying an existing Builder */
  public static com.refactorlabs.cs378.sessions.EventSubtypeStatisticsKey.Builder newBuilder(com.refactorlabs.cs378.sessions.EventSubtypeStatisticsKey.Builder other) {
    return new com.refactorlabs.cs378.sessions.EventSubtypeStatisticsKey.Builder(other);
  }
  
  /** Creates a new EventSubtypeStatisticsKey RecordBuilder by copying an existing EventSubtypeStatisticsKey instance */
  public static com.refactorlabs.cs378.sessions.EventSubtypeStatisticsKey.Builder newBuilder(com.refactorlabs.cs378.sessions.EventSubtypeStatisticsKey other) {
    return new com.refactorlabs.cs378.sessions.EventSubtypeStatisticsKey.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<EventSubtypeStatisticsKey>
    ...
    private Builder() {
      super(com.refactorlabs.cs378.sessions.EventSubtypeStatisticsKey.SCHEMA$);
    }
    
    /** Creates a Builder by copying an existing Builder */
    private Builder(com.refactorlabs.cs378.sessions.EventSubtypeStatisticsKey.Builder other) {
      super(other);
    }
    
    /** Creates a Builder by copying an existing EventSubtypeStatisticsKey instance */
    private Builder(com.refactorlabs.cs378.sessions.EventSubtypeStatisticsKey other) {
            super(com.refactorlabs.cs378.sessions.EventSubtypeStatisticsKey.SCHEMA$);
    ...
    /** Sets the value of the 'session_type' field */
    public com.refactorlabs.cs378.sessions.EventSubtypeStatisticsKey.Builder setSessionType(java.lang.CharSequence value) {
    ...
    public com.refactorlabs.cs378.sessions.EventSubtypeStatisticsKey.Builder clearSessionType() {
      session_type = null;
    ...
    /** Sets the value of the 'event_subtype' field */
    public com.refactorlabs.cs378.sessions.EventSubtypeStatisticsKey.Builder setEventSubtype(java.lang.CharSequence value) {
    ...
    public com.refactorlabs.cs378.sessions.EventSubtypeStatisticsKey.Builder clearEventSubtype() {
      event_subtype = null;
